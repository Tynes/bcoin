...
class FileBlockStore extends AbstractBlockStore {
  ...
  // NOTE: hash (they key) is no longer a block hash for
  // types.FILTER, it is b(U8 type || hash)
  ...
  // TODO: this is broken, hash is assumed to be 32 bytes
  // but it is 33 bytes with types.FILTER
