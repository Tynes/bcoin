...
class RPC extends RPCBase {
  ...
  init() {
    ...
    this.add('testmempoolaccept', this.testMempoolAccept);
  ...
  // TODO: here
  async testMempoolAccept(args, help) {
    // see bitcoind PR:
    // https://github.com/bitcoin/bitcoin/commit/b55555da3e25a47f1e7fced7f09d4f0bf8198624
